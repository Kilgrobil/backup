...
Ceci est vérifié dès lors qu'on a l'égalité ensembliste $\{ \lb M' \rb_\sigma(\eta') \mid \eta' \in \lb M' \rb_{\Sigma'} \} = \lb \Mod(\sigma)(M') \rb_\Sigma$. Or, $\lb M' \rb_\sigma : \lb M' \rb_{\Sigma'} \to \lb \Mod(\sigma)(M') \rb_\Sigma$ est un morphisme surjectif (par définition d'une institution stratifiée), donc l'égalité est vraie.
\end{proof}
{\color{purple} Stratification interne.}
\newpage
