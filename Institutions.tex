...
\itemz Pour tout $h : (I,W,R) \to (I',W',R')$, $\lb h \rb_P : (I,R) \to (I',R')$ est le morphisme de graphes sous-jacent à $h$. On a $\lb $ [fonctorialité]
\itemz Pour tout $\sigma : P \to P'$, on définit $\lb (I',W',R') \rb_\sigma = id_{(I',R')}$.
\end{itemize}
\newpage
